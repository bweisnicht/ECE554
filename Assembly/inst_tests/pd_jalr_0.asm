...
//   0 - This means your processor did not jump to jalrtarget, or did not halt.
//   1 - Your processor jumped to .jalrtarget, but did not return correctly.
//   2 - Everything's shiney!

lbi r1, .jalrtarget     // Load an address to jump to.
jalr r1, 0              // Jump and link to that address.
